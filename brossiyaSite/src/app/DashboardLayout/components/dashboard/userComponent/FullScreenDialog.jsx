...
export default function FullScreenDialog({ handleClose, dataa }) {
  ...
  const tabs = [
    ...
    {
      label: "Reclamation",
      component: <Reclamation dataa={Infraction} />,
      show: showTabs.claim,
    },
    {
      label: "Payment",
      component: <TabPayment data={Infraction} />,
      show: showTabs.payment,
    },
    {
      label: "La décision prise",
      component: <Decision status={status} />,
      show: showTabs.decision,
    },
    {
      label: "REMARQUE",
      component: <Remarque status={status} />,
      show: showTabs.remarque,
    },
  ];
